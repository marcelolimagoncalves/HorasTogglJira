...
namespace TogglJiraService
{
    public partial class Service1 : ServiceBase
    {
        ...
        {
            EventLog.WriteEntry("Iniciando a Integração Toggl x Jira", EventLogEntryType.Warning);

            RunAsync().GetAwaiter().GetResult();

            EventLog.WriteEntry("Finalizando a Integração Toggl x Jira", EventLogEntryType.Warning);
